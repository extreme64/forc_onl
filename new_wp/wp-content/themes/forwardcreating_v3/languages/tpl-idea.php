...
?>
	...
	<div id="primary" class="content-area color-0">
		<main id="main" class="site-main main-idea nodes-bg">
            ...
            <div class="row">
              <div class="col-md-6">
                <span class="i-h4-wrap margin-top-0a">
                  ...
                  <h4 class="">Flexibility, reusability, modularity, recyclability<!-- accessibility.longevity --></h4>
                </span>
              </div>
              <div class="col-md-6">
                <span class="i-h4-wrap margin-top-0a">
                  <i class="fas fa-landmark"></i>
                  <h4 class="">Open source and public domain</h4>
                </span>
              </div>
            <div class="row">
            </div>
              <div class="col-md-6">
                <span class="i-h4-wrap margin-top-0a">
                  ...
                  <h4 class="">Voluntary cooperative participation </h4>
                </span>
              </div>
              <div class="col-md-6">
                <span class="i-h4-wrap margin-top-0a">
                  <i class="fas fa-less-than-equal"></i>
                  <h4 class="">Stride towards a zero new resources extraction</h4>
                </span>
              </div>
            </div>
          </div>
      ...
      <style media="screen">
        .sec-why-bg {
          /* background: url(<?php // print get_site_url() ?>/wp-content/uploads/2019/09/download-13.jpg); */
        }
      </style>
