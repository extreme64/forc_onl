...
define('OWA_DB_NAME', 'extreme1_owa'); // name of the database
define('OWA_DB_HOST', 'localhost'); // host name of the server housing the database
define('OWA_DB_USER', 'extreme1_fc_boss'); // database user
define('OWA_DB_PASSWORD', 'nico_boss_666'); // database user's password
 ...
 */
define('OWA_NONCE_KEY', 'awerw5445dfdfddfdf');  
define('OWA_NONCE_SALT', 'dfghfr57gfgfggfg');
define('OWA_AUTH_KEY', 'fghiuiuuiuidfdfdfdfd');
define('OWA_AUTH_SALT', 'ghjgi8tewwewewewe');
...
define('OWA_PUBLIC_URL', 'http://www.forwardcreating.com/owa/');  
