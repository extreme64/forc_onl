...
class UIViews {
    ...
    const CHECKBOX_BOX = '<path class="cb-box" d="M303.118,0H56.882C25.516,0,0,25.516,0,56.882v246.236C0,334.484,25.516,360,56.882,360h246.236
    ...
    const CHECKBOX_CHECK = ' <path class="cb-check hide-svg" d="M249.844,106.585c-6.116,0-11.864,2.383-16.19,6.71l-84.719,84.857l-22.58-22.578c-4.323-4.324-10.071-6.706-16.185-6.706
    ...
    const CHECKBOX_ICO_CHECKED = '<svg class="svg-cb cb-check" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 360 360" style="enable-background:new 0 0 360 360;" xml:space="preserve">
                    <g>'.self::CHECKBOX_BOX . self::CHECKBOX_CHECK.'</g></svg>';

    const CHECKBOX_ICO_UNCHECKED = '<svg class="svg-cb cb-box" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 360 360" style="enable-background:new 0 0 360 360;" xml:space="preserve">
                    <g>'.self::CHECKBOX_BOX .'</g></svg>';
